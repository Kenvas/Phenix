...
namespace kv
{
    namespace entry
    {
        ...
        {
            static CommandArgs _ParseInput(StringType const & input)
            {
                autox p = input.c_str();
                autox q = p;
                autox eof    = (*q == 0);
                autox quoted = false;
                autox retval = CommandArgs();
            ...
            static CommandArgs _SplitPath(StringType const & input)
            {
                autox p = input.c_str();
                autox q = p;
                autox eof = (*q == 0);
                autox ret = CommandArgs();
