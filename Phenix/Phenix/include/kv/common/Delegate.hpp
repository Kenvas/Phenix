...
namespace kv
{
    ...
    public:
        ...
        constexpr auto InvokeFreeFunction(ArgTypes && ... args) const
        {
            ...
            //{
            //default                     :
            //case kv::CallType::CDecl   : return InvokeFreeFunction__cdecl   (std::forward<ArgTypes>(args) ...);
            //case kv::CallType::StdCall : return InvokeFreeFunction__stdcall (std::forward<ArgTypes>(args) ...);
            //case kv::CallType::FastCall: return InvokeFreeFunction__fastcall(std::forward<ArgTypes>(args) ...);
            //}
        }
        ...
        constexpr auto InvokeMemberFunction(ArgTypes && ... args) const
        {
            ...
            //switch (CallType_)
            //{
            //case kv::CallType::CDecl   : return InvokeMemberFunction__cdecl   (std::forward<ArgTypes>(args) ...);
            //case kv::CallType::StdCall : return InvokeMemberFunction__stdcall (std::forward<ArgTypes>(args) ...);
            //case kv::CallType::FastCall: return InvokeMemberFunction__fastcall(std::forward<ArgTypes>(args) ...);
            //default                     :
            //case kv::CallType::ThisCall: return InvokeMemberFunction__thiscall(std::forward<ArgTypes>(args) ...);
            //}
        }
    private:
